import {FunctionsClient} from "/-/@supabase/functions-js@v2.95.3-f9XrQVdoU3Zsvxk6Zxyi/dist=es2019,mode=imports/optimized/@supabase/functions-js.js";
export {FunctionRegion, FunctionsError, FunctionsFetchError, FunctionsHttpError, FunctionsRelayError} from "/-/@supabase/functions-js@v2.95.3-f9XrQVdoU3Zsvxk6Zxyi/dist=es2019,mode=imports/optimized/@supabase/functions-js.js";
import {PostgrestClient} from "/-/@supabase/postgrest-js@v2.95.3-lCP1IPTNGvKsdRqos1Eg/dist=es2019,mode=imports/optimized/@supabase/postgrest-js.js";
export {PostgrestError} from "/-/@supabase/postgrest-js@v2.95.3-lCP1IPTNGvKsdRqos1Eg/dist=es2019,mode=imports/optimized/@supabase/postgrest-js.js";
import {RealtimeClient} from "/-/@supabase/realtime-js@v2.95.3-DgQyEj8jOXGiqzCI2R5W/dist=es2019,mode=imports/optimized/@supabase/realtime-js.js";
export * from "/-/@supabase/realtime-js@v2.95.3-DgQyEj8jOXGiqzCI2R5W/dist=es2019,mode=imports/optimized/@supabase/realtime-js.js";
import {StorageClient} from "/-/@supabase/storage-js@v2.95.3-WonpGhtVGQon38pcUyYc/dist=es2019,mode=imports/optimized/@supabase/storage-js.js";
import {AuthClient} from "/-/@supabase/auth-js@v2.95.3-ofCHYfwL8osZ7lG4ZbDc/dist=es2019,mode=imports/optimized/@supabase/auth-js.js";
export * from "/-/@supabase/auth-js@v2.95.3-ofCHYfwL8osZ7lG4ZbDc/dist=es2019,mode=imports/optimized/@supabase/auth-js.js";
